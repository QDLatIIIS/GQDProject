...
function [n1, n2, n3, E1r, E3r, Ef_t]=iter20160429Ave(nt, nb, T1,T2,T3,Ef,E1,E3, lambda, kappa, tol)
...
count = 0;
while true
    n1t = lambda*n1+(1-lambda)*n1t;n2t =lambda*n2+(1-lambda)*n2t;n3t = lambda*n3+(1-lambda)*n3t;
