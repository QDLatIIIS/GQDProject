...
def make_system(a=1, t=1.0, r=20):
    ...
    """quadratic potential"""
    def onsite(site, *args):
        x, y = site.pos
        rsq = x**2+y**2
        return (rsq/r**2)*t + 4*t
...
def main():
    """modified r(original 20)"""
    sys = make_system(r=20)
    ...
    try:
        ...
        plot_spectrum(sys, [iB * 0.001 for iB in xrange(20)], numOfEnLevel=20)
        ...
        #plot_wave_function(sys, numOfEigenVec=10)
